...
const api = {
  deptInfo: '/api/dds/system/dept',
  add: '/api/dds/system/dept/add',
  pageList: '/api/dds/system/dept/page',
  list: '/api/dds/system/dept/list',
  deleteDept: '/api/dds/system/dept/delete',
  updateDept: '/api/dds/system/dept/update'
}
/**
 * 获取登录前需要展示的模块
 */
